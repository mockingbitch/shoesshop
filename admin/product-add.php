...
if (isset($_POST['cancel'])){
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['add'])){
        ...
        $brand = $_POST['brand'];
        $add_product = $product->add_product($productName,$productDescription,$productPrice,$productQuantity,$brand,$_FILES);
    }
?>
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h2 class="card-title" align="center" style="font-size: 30px;margin: 50px 0 50px 0">Thêm sản phẩm</h2>
            <p class="card-description"><?php if (isset($add_product)) echo $add_product; ?></p>
            <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="number" name="productPrice" class="form-control" placeholder="Giá sản phẩm" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="productQuantity" class="form-control" id="exampleInputCity1" placeholder="Số lượng" />
                </div>
                <div class="form-group">
