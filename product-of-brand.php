        ...
        <div class="row">
            ...
            <div id="store" class="col-md-9">
                ...
                <div class="row">
                    ...
                    $product = new product();
                    $show_product = $product->show_product_by_brand($id);
                    if ($show_product){
                            ...
                            <div class="col-md-4 col-xs-6">
                                ...
                                <div class="single-product" style="border: 1px solid grey">
                                    <div class="product-img" >
                                        <a href="productdetail.php?id=<?= $result['productId']; ?>">
                                            <img class="default-img" src="admin/uploads/products/<?= $result['img']; ?>" alt="#">
                                            <img class="hover-img" src="admin/uploads/products/<?= $result['img']; ?>" alt="#">
                                    ...
                                    <div class="product-content">
                                        <h3 align="center"><a href="productdetail.php?id=<?= $result['productId'] ?>"><?= $result['productName']; ?></a></h3>
